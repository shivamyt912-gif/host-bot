...
TOKEN = os.getenv('TOKEN', '8720083326:AAEBsX0luqP7Gk9CPX4KJlyEna1Ku80Bz90')
OWNER_ID = int(os.getenv('OWNER_ID', 8287631509))
ADMIN_ID = int(os.getenv('ADMIN_ID', 8287631509))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', 'SHIVAM_YADAV79')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'SHIVAM_YT_FF')
...
**Support:** @SHIVAM_YADAV79
**Updates:** @SHIVAM_YT_FF
"""
